...
def identite_client():
    ...
    infos_client = requests.get(URL_API + "infos_client/"+str(id_client), params={"id_client":id_client})
...
def load_prediction():
    ...
    prediction = requests.get(URL_API + "predict/"+str(id_client), params={"id_client":id_client})
...
def load_voisins():
    ...
    voisins = requests.get(URL_API + "load_voisins/"+str(id_client), params={"id_client":id_client})
